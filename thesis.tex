...
\begin{figure}
  ...
  \begin{minipage}{.5\textwidth}
    ...
    \end{center}
  \end{minipage}
  \caption{Performance of PSS on SMP Machine}\label{ssp_analysis_smp_performance}
\end{figure}
...
\begin{figure}
  ...
  \begin{minipage}{.5\textwidth}
    ...
    \end{center}
  \end{minipage}
  \caption{Memory Analysis of PSS on SMP Machine}\label{ssp_analysis_smp_memory}
\end{figure}
