...
will always be counted in the minimum clock value before another token is sent. Since this cannot
be gaurenteed in \textsc{warped2}, a running minimum of the white message timestamps received is
recorded to ensure that all white messages are included in the final GVT value.
...
\SetKwBlock{Send}{sendEvent}{end}
    ...
    \caption{Termination: Worker Threads}
\end{algorithm}
