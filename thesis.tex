...
\begin{center}
    ...
    \hline
        \multicolumn{2}{|l|}{} & \multirow{2}{*}{Intel Core i7-4770} & \multirow{2}{*}{Intel Xeon} & \multicolumn{2}{c||}{Exynos 5422} \\ \cline{5-6}
        \multicolumn{2}{|l|}{} & & & Cortex-A15 & Cortex-A7 \\ [0.5ex]
        \hline\hline
        \multirow{7}{*}{Processor}
            & ISA           & x86\_64   & ? & \multicolumn{2}{c||}{ARMv7} \\
            & Cores         & 4         & 8 & 4         & 4 \\
            & Frequency     & 3.4 GHz   & ? & 2.0 GHz   & 1.4 GHz \\
            & L1 Data Cache & 32kB      & ? & 32kB      & 32kB \\
            & L1 Inst Cache & 32kB      & ? & 32kB      & 32kB \\
            & L2 Cache      & 256kB     & ? & 2MB       & 512kB\\
            & L3 Cache      & 8MB       & ? & \multicolumn{2}{c||}{N/A} \\
        \hline
        \multirow{2}{*}{Memory}
...
\SetAlgoVlined
    ...
    \Begin{
        ...
        \Repeat{$ticket = my\_number$}{nothing}
    }
    \;
    \tcc{Release}
    \Begin{
