...
%% DOUG: you also need to give citations and credit to the original papers that introduced all of
%% these simulation models.  the only one that does not specifically come from the published
%% literature is the Traffic model; for that one i have included the appropriate pointer/credit back
%% to the ROSS simulation team. (your citation for the epidemic model is fine).
...
%% DOUG: i doubt that you could actually get this next paragraph though the community without some
%% grief; for example, i would be offended at this portail of the pGVT algorithm.  i'll let you get
%% away with it here, but you might want to rewrite this paragraph to simply provide a list of
%% citations to the other, lesser known, less used GVT estimation algorithms.
...
message passing alorithm is initiated.  The integration of the shared memory algorithm is
...
%% DOUG: complete the citation at the end of this next paragraph
...
%% DOUG: yes, you should repeat the citations here.
