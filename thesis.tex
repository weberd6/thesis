...
mechanism of the individual LP's such as rolling back and fossil collecting whereas
...
each LP and possibly any extra scheduling data structures. The event set provides methods for
obtaining the next event, processing a rollback, and fossil collecting processed events. All the
data structures that have pending events must necessarily be thread safe since multiple worker
...
Throughout the rest of this text, a measure called the \emph{efficieny} will be one of the main
...
\begin{table}[H]
    ...
    \begin{tabular}{| c | c | c | c |}
        ...
        \hline
        Number of LTSF Queues & Speedup and Efficiency   & Figure \ref{ltsf_analysis}    & X5675             \\
        \hline
        LTSF Queue Partitioning & Time and Efficiency    & Figures \ref{ltsf_partitioning_bc},
            \ref{ltsf_partitioning_beowulf}    & X5675, E5410 \\
        \hline
        State Saving Period & Speedup, ...  & Figure \ref{ssp_analysis_smp_performance} & X5675 \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{| c | c | c | c |}
        ...
        \textbf{Comparison} & \textbf{Measure(s)}  & \textbf{Figure(s)}   & \textbf{Machine(s)}  \\
        \hline
        Communication Model & Speedup and Efficiency & Figure \ref{model_communication}  & E5410 \\
        \hline
        ...
        \hline
        State Saving Period & Speedup, ...   & Figure \ref{ssp_analysis_cluster} & E5410 \\
        \hline
