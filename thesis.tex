...
\textsc{warped2} allows the user to choose the number of LTSF queues 
...
%% Explain plots
The plots below show the speedup and rollback changes as the number of LTSF queues change for
some of the \textsc{warped2} models.
...
events, and \item rescheduling new events \end{inparaenum}.
...
\subsubsection{Partitioning in \textsc{warped2}}
